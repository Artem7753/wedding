...
export const Banner = ({ guests, isMale }) => {
  ...
  return (
    <>
      ...
      <p className="description_wrapper">
        <div className="banner_title">Мы рады пригласить вас на нашу свадьбу!</div>
        <div className="banner_text">
          Мы оба так счастливы и воодушевлены и невероятно хотим поделиться этой
          радостью с вами. Мы хотим, чтобы этот день запомнился нам и вам на всю
          жизнь!
        </div>
      </p>
    </>
